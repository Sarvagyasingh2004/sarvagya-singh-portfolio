...
// Four things that actually happened, with the numbers attached. Plain totals
// ("12 months", "331 commits") say almost nothing on their own — a before and
// an after says what changed and by how much. Each carries the logo of the
// thing it was done to, drawn from the site's own icon set.
const counterItems = [
  {
    before: "~40s",
    after: "~400ms",
...
const techStackIcons = [
  // Kept to what the work is actually built in, and to a single row: languages
  // -> frontend -> backend -> data -> messaging. Git, GitHub, Postman and
  // JavaScript were dropped as tooling rather than stack.
